...
class IhsanVocabulary:
    ...
    @classmethod
    def normalize_dict(cls, data: Dict[str, Any], target: str = "english") -> Dict[str, Any]:
        """
        Normalize dictionary keys to target vocabulary (english or arabic).
        """
        result = {}
        mapping = cls.ARABIC_TO_ENGLISH if target == "english" else cls.ENGLISH_TO_ARABIC
...
if __name__ == "__main__":
    ...
    dims = DimensionScores(quality=1.0, utility=1.0, trust=1.0, fairness=1.0, diversity=1.0)
