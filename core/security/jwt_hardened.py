...
class SecretValidator:
    ...
    WEAK_PATTERNS = [
        ...
        "12345", "qwerty", "admin", "test", "dev",
        "production", "staging", "jwt", "token"
    ]
    ...
    def analyze(cls, secret: str, algorithm: str = "HS256") -> SecretAnalysis:
        ...
        if length < min_length // 2:
            ...
            recommendations.append(f"Secret should be at least {min_length} characters for {algorithm}")
        elif is_common:
            strength = SecretStrength.WEAK
            ...
            strength = SecretStrength.WEAK
            recommendations.append("Secret has low entropy - use more character variety")
            ...
            try:
                payload = jwt.decode(
                    ...
                    options={
                        ...
                        if self._config.require_jti else ["exp", "iat", "sub"]
                    }
                )
                break  # Success
