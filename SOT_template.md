# BIZRA Single Source of Truth (SOT) Template

This template is intended to serve as the **canonical reference** for your unified BIZRA project. All other documentation, code, and tests should align with the definitions and rules set here. Feel free to adjust names and parameters, but ensure every change is backed by evidence.
...
Use relative paths or URLs to link evidence artifacts in other repositories or storage buckets.
