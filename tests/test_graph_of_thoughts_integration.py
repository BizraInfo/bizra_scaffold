...
def mock_l4_hypergraph():
    ...
    mock.get_neighbors_with_domains = AsyncMock(return_value=[
        {
            'id': 'ConceptA',
...
class TestEndToEndIntegration:
    ...
    async def test_process_observation_with_got(
        ...
        mock_convergence.compute = Mock(return_value=ConvergenceResult(
            clarity=0.80,
        ...
        mock_narrative = Mock()
        mock_narrative.compile = Mock(return_value=Mock(
    ...
    async def test_process_without_got(
        self,
        mock_l4_hypergraph,
        sample_observation
    ):
