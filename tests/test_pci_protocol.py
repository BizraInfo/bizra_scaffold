...
# Import agents
from core.agents.pat import PATAgent, PATConfig, create_pat_agent, IHSAN_THRESHOLD
...
class TestPATAgent:
    ...
    def test_stats_tracking(self, pat_agent, valid_policy_hash):
        ...
        pat_agent.create_proposal("a2", {}, valid_policy_hash, ihsan_score=0.85)  # Rejected
...
class TestVectors:
    ...
    def test_ihsan_threshold_vector(self, test_vectors):
        ...
        vector = next(
            v for v in test_vectors["test_cases"]
