...
class TestValueOracle:
    ...
    def test_reputation_trust_clamped(self):
        ...
        from core.value_oracle import ReputationOracle, Convergence
...
class TestQuantumSecurity:
    ...
    def test_import(self):
        """Test module imports correctly."""
        from core.security.quantum_security_v2 import (
            QuantumSecurityV2,
            TemporalProof
        )
    ...
    async def test_chain_locking(self, temp_key_dir):
        ...
        operations = [
            {"type": "op", "id": i} for i in range(10)
        ]
...
class TestIhsanBridge:
    ...
    def test_blake3_attestation_id(self):
        ...
        actual = AttestationBridge.compute_attestation_id(contributor, epoch, evidence_root)
